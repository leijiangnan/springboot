package com.gzdx.test.spring.springboot.generator;
...
public class MysqlGenerator {
    ...
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/mytest?useUnicode=true&characterEncoding=UTF-8";
